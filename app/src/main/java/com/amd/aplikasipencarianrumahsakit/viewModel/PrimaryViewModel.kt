package com.amd.aplikasipencarianrumahsakit.viewModel

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.amd.aplikasipencarianrumahsakit.Networking.ApiClient
import com.amd.aplikasipencarianrumahsakit.Networking.ApiInterface
...
class PrimaryViewModel : ViewModel() {
    ...
    private val modelProvinsiMutableLiveData =
        MutableLiveData<ArrayList<ModelProvinsiResult.ModelProvinsi>>()
    private val modelKotaMutableLiveData = MutableLiveData<ArrayList<ModelKotaResult.ModelKota>>()
    private val modelHospitalCovidMutableLiveData =
        MutableLiveData<ArrayList<ModelHospitalCvd.ModelHospitalC>>()
    private val modelHospitalNonCovidMutableLiveData =
        MutableLiveData<ArrayList<ModelHospitalNCvd.ModelHospitalNCovid>>()
    private val modelDataMutableLiveData =
        MutableLiveData<ArrayList<ModelDetailResult.ModelData.BedDetail>>()
    ...
    fun setKota(ProvinsiId: String) {
        ...
        call.enqueue(object : Callback<ModelKotaResult> {
            override fun onResponse(
                call: Call<ModelKotaResult>,
                response: Response<ModelKotaResult>
            ) {
                if (!response.isSuccessful) {
                    Log.e("response", response.toString())
                } else if (response.body() != null) {
    ...
    fun setHospitalsCovid(ProvinsiId: String, KotaId: String) {
        ...
        call.enqueue(object : Callback<ModelHospitalCvd> {
            override fun onResponse(
                call: Call<ModelHospitalCvd>,
                response: Response<ModelHospitalCvd>
            ) {
                if (!response.isSuccessful) {
                    Log.e("response", response.toString())
                } else if (response.body() != null) {
    ...
    fun setHospitalsNonCovid(ProvinsiId: String, KotaId: String) {
        ...
        call.enqueue(object : Callback<ModelHospitalNCvd> {
            override fun onResponse(
                call: Call<ModelHospitalNCvd>,
                response: Response<ModelHospitalNCvd>
            ) {
                if (!response.isSuccessful) {
                    Log.e("response", response.toString())
                } else if (response.body() != null) {
    ...
    fun setDetailsCovid(HospitalId: String) {
        ...
        call.enqueue(object : Callback<ModelDetailResult> {
            override fun onResponse(
                call: Call<ModelDetailResult>,
                response: Response<ModelDetailResult>
            ) {
                if (!response.isSuccessful) {
                    Log.e("response", response.toString())
                } else if (response.body() != null) {
    ...
    fun getProvinsi(): LiveData<ArrayList<ModelProvinsiResult.ModelProvinsi>> =
        modelProvinsiMutableLiveData

    fun getKota(): LiveData<ArrayList<ModelKotaResult.ModelKota>> = modelKotaMutableLiveData

    fun getHospitalsCovid(): LiveData<ArrayList<ModelHospitalCvd.ModelHospitalC>> =
        modelHospitalCovidMutableLiveData

    fun getHospitalsNonCovid(): LiveData<ArrayList<ModelHospitalNCvd.ModelHospitalNCovid>> =
        modelHospitalNonCovidMutableLiveData

    fun getDetailsCovid(): LiveData<ArrayList<ModelDetailResult.ModelData.BedDetail>> =
        modelDataMutableLiveData

    fun getDetailsNonCovid(): LiveData<ArrayList<ModelDetailResult.ModelData.BedDetail>> =
        modelDataMutableLiveData
